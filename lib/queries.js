 ...
 *     classification code.
 * @property {string} [religionType] - If it is a worship administrative unit,
 *     the URI of the recognized worship type.
 *
 ...
 * @param {string} governingBodyInTime ${2} - the URI of the governing body of
 *     the related governing body.
