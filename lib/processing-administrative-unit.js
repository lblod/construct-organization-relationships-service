...
function isWorshipAdministrativeUnit(classification) {
  return (
    classification == ORGANZATION_CLASSIFICATIONS.EB ||
    classification == ORGANZATION_CLASSIFICATIONS.CB
  );
}

function isWorshipService(classification) {
  return classification == ORGANZATION_CLASSIFICATIONS.EB;
}
