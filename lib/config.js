...
export const START_DATE_POLITIECOLLEGE =
  process.env.START_DATE_POLITIECOLLEGE || "2026-07-02T00:00:00";

export const IN_OPRICHTING_STATUS = "http://lblod.data.gift/concepts/abf4fee82019f88cf122f986830621ab";
export const ACTIVE_STATUS = "http://lblod.data.gift/concepts/63cc561de9188d64ba5840a42ae8f0d6";
export const INACTIVE_STATUS = "http://lblod.data.gift/concepts/d02c4e12bf88d2fdf5123b07f29c9311";
...
export const ORGANIZATION_CLASSIFICATIONS = {
  ...
  // New org types (data.vlaanderen.be URIs, to be published). Bestuurseenheid family:
  INTERLOKALE_VERENIGING:
    "http://data.vlaanderen.be/id/concept/BestuurseenheidClassificatieCode/3a2649ef-7345-4d3a-8709-f89fc9b44f58",
  VERVOERREGIORAAD:
    "http://data.vlaanderen.be/id/concept/BestuurseenheidClassificatieCode/b2133b86-24f0-44f0-9d10-5b4c7f944a9d",
  // Geregistreerde Organisatie family (VZW / BV):
  ZORGRAAD:
    "http://data.vlaanderen.be/id/concept/GeregistreerdeOrganisatieClassificatieCode/8392b885-a875-4b0d-b6a2-b52e53bda454",
  BOSGROEP:
...
const VERVOERREGIORAAD_ORGAAN   = "http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/a04a5fb1-b79c-4b8d-a664-c5410d466d49";
...
const POLITIECOLLEGE = "http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/4f82dfea-0581-43d4-b672-3bdb261d2d33";
...
const VOORZITTER_VAN_DE_RAAD_VOOR_MAATSCHAPPELIJK_WELZIJN = "http://data.vlaanderen.be/id/concept/BestuursfunctieCode/5ab0e9b8a3b2ca7c5e000016";
...
export const BESTUURSLID_VAN_HET_BESTUUR_VAN_DE_EREDIENST_KLEINE_HELFT   = "http://data.vlaanderen.be/id/concept/BestuursfunctieCode/2962f0bd-2836-4758-9866-8ce8ea2c536f";
export const BESTUURSLID_VAN_HET_BESTUUR_VAN_DE_EREDIENST_GROTE_HELFT    = "http://data.vlaanderen.be/id/concept/BestuursfunctieCode/a8b5509b-f86b-48f8-94d6-fe463a9b77e3";
...
export const WORSHIP_IN_OPRICHTING_MANDATES = [
...
export const MANDATES_SPANNING_ALL_PERIODS = [
...
const VOORZITTER_VERVOERREGIORAAD_BESTUURSFUNCTIE   = "http://data.vlaanderen.be/id/concept/BestuursfunctieCode/540f3be6-73ed-4935-9de7-30997bab379c";
const LID_VERVOERREGIORAAD_BESTUURSFUNCTIE          = "http://data.vlaanderen.be/id/concept/BestuursfunctieCode/1093c55c-84d5-424b-980e-8b2ca32dc445";
...
// New org types.
// Zorgraad (VZW), Bosgroep (VZW), Woonmaatschappij (BV) -> standard VZW/vennootschap organs.
const zorgraad = [
  RAAD_VAN_BESTUUR,
  ALGEMENE_VERGADERING,
  LEIDEND_AMBTENAAR
...
const vervoerregioraad = [
  VERVOERREGIORAAD_ORGAAN
];

// Interlokale vereniging has geen rechtspersoonlijkheid -> no besluit:Bestuursorgaan (no OP precedent for
// an orgaan on a non-rechtspersoon). Composition is modeled via org:membership (participating gemeenten).
const interlokaleVereniging = [];
...
export const GOVERNING_BODY_CLASSIFICATIONS = {
  ...
  [ORGANIZATION_CLASSIFICATIONS.CORPORATION_OTHER]:
    corporationOther,
  [ORGANIZATION_CLASSIFICATIONS.ZORGRAAD]:
    zorgraad,
  [ORGANIZATION_CLASSIFICATIONS.BOSGROEP]:
    bosgroep,
...
export const MANDATE_CLASSIFICATIONS = {
  ...
  [VERVOERREGIORAAD_ORGAAN]:
    [
      VOORZITTER_VERVOERREGIORAAD_BESTUURSFUNCTIE,
      LID_VERVOERREGIORAAD_BESTUURSFUNCTIE,
    ],
  [VOORZITTER_VAN_HET_BIJZONDER_COMITE_VOOR_DE_SOCIALE_DIENST]:
    [
