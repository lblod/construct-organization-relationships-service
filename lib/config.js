export const START_DATE_NON_WORSHIP_GOVERNING_BODY = process.env.START_DATE_NON_WORSHIP_GOVERNING_BODY || "2019-01-01T00:00:00";
export const END_DATE_NON_WORSHIP_GOVERNING_BODY = process.env.END_DATE_NON_WORSHIP_GOVERNING_BODY;
export const START_DATE_WORSHIP_GOVERNING_BODY = process.env.START_DATE_WORSHIP_GOVERNING_BODY || "2020-04-01T00:00:00";
export const END_DATE_WORSHIP_GOVERNING_BODY = process.env.END_DATE_WORSHIP_GOVERNING_BODY || "2023-03-31T00:00:00";
export const GRAPH = process.env.GRAPH || "http://mu.semte.ch/graphs/organisatieportaal";
...
const roomsKatholiekEB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/04f65457bf125b2dc59fd71917ac3d08']; // Kerkraad
const protestantEB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/90a9ec83cb93b9369bba7ff29d9ce5ce']; // Bestuursraad
const orthodoxEB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/af811edba97c6ec34874d0830cbb1183']; // Kerkfabriekraad
const islamitischEB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/b475fa47e17a8a05ae04a9e1fb9c9258']; // Comité
const anglicaansEB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/04f65457bf125b2dc59fd71917ac3d08']; // Kerkraad
const israelitischEB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/90a9ec83cb93b9369bba7ff29d9ce5ce']; // Bestuursraad

const worshipService = {
  'http://lblod.data.gift/concepts/b13d1d623626bc1ee75c7d20bc60e3c0': roomsKatholiekEB,
  'http://lblod.data.gift/concepts/e8cba1540b35a32e9cb45126c38c03c6': protestantEB,
  'http://lblod.data.gift/concepts/84bcd6896f575bae4857ff8d2764bed8': orthodoxEB,
  'http://lblod.data.gift/concepts/9d8bd472a00bf0a5c7b7186606365a52': islamitischEB,
  'http://lblod.data.gift/concepts/99536dd6eb0d2ef38a89efafb17e7389': anglicaansEB,
  'http://lblod.data.gift/concepts/1a1abeafc973d27cebcb2d7a15b2d823': israelitischEB
};

const roomsKatholiekCB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/0d985699479162198b889f10e4f1a8ce']; // Centraal kerkbestuur
const protestantCB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/0d985699479162198b889f10e4f1a8ce']; // Centraal kerkbestuur
const orthodoxCB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/0d985699479162198b889f10e4f1a8ce']; // Centraal kerkbestuur
const islamitischCB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/4393389e99127b68e7fc11936ba92e18']; // Centraal bestuur
const anglicaansCB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/0d985699479162198b889f10e4f1a8ce']; // Centraal kerkbestuur
const israelitischCB = ['http://data.vlaanderen.be/id/concept/BestuursorgaanClassificatieCode/4393389e99127b68e7fc11936ba92e18']; // Centraal bestuur

const centralWorshipService = {
  'http://lblod.data.gift/concepts/b13d1d623626bc1ee75c7d20bc60e3c0': roomsKatholiekCB,
  'http://lblod.data.gift/concepts/e8cba1540b35a32e9cb45126c38c03c6': protestantCB,
  'http://lblod.data.gift/concepts/84bcd6896f575bae4857ff8d2764bed8': orthodoxCB,
  'http://lblod.data.gift/concepts/9d8bd472a00bf0a5c7b7186606365a52': islamitischCB,
  'http://lblod.data.gift/concepts/99536dd6eb0d2ef38a89efafb17e7389': anglicaansCB,
  'http://lblod.data.gift/concepts/1a1abeafc973d27cebcb2d7a15b2d823': israelitischCB
};
...
export const GOVERNING_BODY_CLASSIFICATIONS = {
  ...
  'http://data.vlaanderen.be/id/concept/BestuurseenheidClassificatieCode/d01bb1f6-2439-4e33-9c25-1fc295de2e71': dienstverlenendeVereniging,
  'http://data.vlaanderen.be/id/concept/BestuurseenheidClassificatieCode/cd93f147-3ece-4308-acab-5c5ada3ec63d': opdrachthoudendeVereniging,
  ...
  'http://data.vlaanderen.be/id/concept/BestuurseenheidClassificatieCode/cc4e2d67-603b-4784-9b61-e50bac1ec089': ocmwVereniging,
  'http://data.vlaanderen.be/id/concept/BestuurseenheidClassificatieCode/d90c511e-f827-488c-84ba-432c8f69561c': vgc,
  'http://data.vlaanderen.be/id/concept/BestuurseenheidClassificatieCode/66ec74fd-8cfc-4e16-99c6-350b35012e86': worshipService,
  'http://data.vlaanderen.be/id/concept/BestuurseenheidClassificatieCode/f9cac08a-13c1-49da-9bcb-f650b0604054': centralWorshipService
};
